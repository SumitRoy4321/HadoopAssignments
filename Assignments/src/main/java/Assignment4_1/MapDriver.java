...
public class MapDriver {
    ...
    private void driver(String tableToInsert, String hdfsInputPath, String hfileOutputPath, Class<EmployeeMapper> employeeMapperClass,Class<BuildingMapper> buildingMapperClass) throws IOException, InterruptedException, ClassNotFoundException {
